#create variables for the input number, all the input numbers added together and how many times the loop has happened

num = 0
add = 0
loop = 0

#while loop asking the user to input a number, adding the input to the add variable and adding 1 to the loop variable
